...
test("create an enemy constructor", () => {
  const enemy = new Enemy("Darth", "lightsaber");

  expect(enemy.name).toBe("Darth");
...
test("gets a description of the enemy", () => {
  ...
  expect(enemy.getDescription()).toEqual(expect.stringContaining("Darth"));
